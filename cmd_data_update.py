...
while user_input != 'exit':
    ...
    if input_list[0] == 'game':
        if input_list[1] == 'add':
            ...
            P1_score = int(input('Player 1 score: '))
            P2 = input('Winning Player 2 Name: ')
            P2_score = int(input('Player 2 score: '))
            P3 = input('Losing Player 3 Name: ')
            P3_score = int(input('Player 3 score: '))
            P4 = input('Losing Player 4 Name: ')
            P4_score = int(input('Player 4 score: '))
            ...
            confirmation = input('Winners: '+P1+':'+str(P1_score)+', '+P2+':'+str(P2_score)+',\n' +
                                 'Losers: '+P3+':'+str(P3_score)+', ' +P4+':'+str(P4_score)+'\n'
                                 'Is this correct? (y/n) ')
